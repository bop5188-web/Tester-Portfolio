(function () {
  ...
  var KB = {
    ...
    shortName: "Brielle",
    tagline:
      "Penn State HCDD student — UX, product design, front-end, and digital marketing. Seeking first full-time role.",
    ...
    roles: [
      {
        ...
        bullets: [
          "Led end-to-end website redesign and implementation (Squarespace + front-end customization) with the founder over a 3-week cycle; helped drive +162% monthly users.",
          "Rebuilt information architecture, navigation, and content hierarchy; +156% user engagement.",
          "Designed a B2B sales pipeline to replace Excel-based deal tracking.",
          "Improved digital presence to support leads, acquisition, and client growth.",
        ],
      },
      {
        ...
        bullets: [
          "Supported digital experience and marketing to improve patient engagement and brand presence.",
          ...
          "Redesigned website UX in Figma — IA, SEO, and content structure for clearer patient navigation.",
        ],
      },
    ],
  };
  ...
  function answerFor(raw) {
    ...
    if (/(elevator|pitch|introduce|summary|tl;?dr|who is brielle|about brielle|tell me about)/.test(q)) {
      return {
        text:
          "30-second pitch: Brielle Picard is a Penn State IST senior pursuing a B.S. in Human-Centered Design & Development (expected May 2027; GPA 3.47, Dean’s List). She’s looking for her first full-time role in UX, product design, digital marketing, or related digital work. Recent experience includes Product Design & Digital Experience Associate at Sales Gauge (website redesign tied to +162% monthly users) and UX Strategy & Digital Marketing Consultant for Emerson Hospital’s AFA OBGYN. Skills span Figma and UX research, HTML/CSS/JavaScript, and Google Analytics (certified). She’s open across industries, with particular interest in healthcare — from medications to medical devices and patient-facing digital tools.",
        links: [
    ...
    if (/(intern|job|hiring|role|fit|recruit|available|opportun)/.test(q)) {
      return {
        text:
          "Brielle is seeking her first full-time role (also open to strong internships). Good fits include UX/UI design, product design, digital experience, digital marketing, front-end, or junior coordinator roles that use research, Figma, web skills, and analytics. She’s industry-flexible, with genuine interest in healthcare products and patient experience when those opportunities come up.",
        links: [
          { href: "mailto:" + KB.email, label: "Email Brielle" },
          { href: KB.resume, label: "Resume" },
        ],
